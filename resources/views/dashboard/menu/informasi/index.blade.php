        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between gap-3">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary" data-bs-target="#create-informasi" data-bs-toggle="modal">+ Tambah</button>
                    </div>
                </div>
            </div>
            <div>
...
{{-- tambah Informasi --}}
<div class="modal fade" id="create-informasi" aria-hidden="true" aria-labelledby="createInformasi" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInformasi">Tambah Infromasi</h5>
                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="judulInformasi" name="title" class="form-control" placeholder="masukan judul informasi">
                        </div>
                        <div class="mb-3">
